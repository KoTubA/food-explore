  ...
  return (
    <div className="bg-white relative flex flex-col justify-between h-dvh text-center pb-44 overflow-hidden w-full max-w-lg md:max-h-[615px] md:pt-8 md:rounded-md">
      ...
      {step === 1 && (
        <div className="flex flex-col items-center p-4 gap-10 flex-grow">
          <div className="relative flex-grow w-full">
            <Image src="/assets/svg/Illustration-1.svg" alt="Krok 1" layout="fill" className="object-contain max-h-64 px-4 flex self-center" />
          </div>
      ...
      {step === 2 && (
        <div className="flex flex-col items-center p-4 gap-10 flex-grow">
          <div className="relative flex-grow w-full">
            <Image src="/assets/svg/Illustration-2.svg" alt="Krok 2" layout="fill" className="object-contain px-4 flex self-center" />
          </div>
          <div className="flex flex-col">
      ...
      {step === 3 && (
        <div className="flex flex-col items-center p-4 gap-10 flex-grow">
          <div className="relative flex-grow w-full">
            <Image src="/assets/svg/Illustration-3.svg" alt="Krok 3" layout="fill" className="object-contain px-4 flex self-center" />
          </div>
          <div className="flex flex-col">
